...
// the exmaple https://github.com/grpc/grpc-kotlin/blob/master/examples/client/src/main/kotlin/io/grpc/examples/animals/AnimalsClient.kt
) : IPageDAO, Closeable {
//    private val pageStub: PageGrpcKt.PageCoroutineStub by lazy { PageGrpcKt.PigCoroutineStub(channel) }
