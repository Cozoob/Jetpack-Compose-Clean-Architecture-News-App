    ...
    override fun getPages(): List<Page> {
     return listOf(
            ...
            Page(
                ...
                description = "Customize your news feed by selecting topics and regions that matter most to you. Receive tailored content, from sports to politics, based on your preferences.",
                image = R.drawable.onboarding2
            ),
            Page(
                title = "Real-Time Alerts & Updates",
                description = "Never miss an important update! Enable notifications to get real-time alerts on major news, live events, and stories that impact you directly.",
