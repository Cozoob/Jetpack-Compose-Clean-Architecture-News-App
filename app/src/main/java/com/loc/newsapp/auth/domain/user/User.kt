...
data class User(val id: String, val username: String, val email: String, val role: UserRole) {
  init { // must always be used in data classes to be sure it will throw error also when copy method
    // used :)
    validate()
  }
